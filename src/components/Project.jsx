...
function Project() {
  ...
  return (
    <div className={` ${darkMode ? 'bg-[#010d19] text-white' : 'bg-white text-black'} section-header panel flex flex-col w-full md:pt-6 bg-transparent pt-4 md:pb-20 pb-6 items-center sm:items-start text-center sm:text-left sm:mx-0 gap-2 xl:gap-3`}>
