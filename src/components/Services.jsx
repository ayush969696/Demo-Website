...
function Services() {
  ...
  return (
    <div className={`section-header panel lg:px-24 md:my-24 my-12 flex flex-col items-center sm:items-start text-center sm:text-left mx-auto sm:mx-0 gap-2 xl:gap-3 ${darkMode ? 'bg-[#010d19] text-white' : 'bg-white text-black'}`}>
