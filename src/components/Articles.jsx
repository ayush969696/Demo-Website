...
function Article() {
  ...
  return (
    <div className={`section-header panel flex flex-col w-full md:pt-24 pt-4 md:pb-20 pb-6 items-center sm:items-start text-center sm:text-left sm:mx-0 gap-2 xl:gap-3 ${darkMode ? ' text-white' : 'bg-white text-black'}`}>
