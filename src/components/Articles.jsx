      ...
      <section className="lg:px-20 w-full mt-4">
        <div className="pt-10 font-Outfit">
          <div className="relative flex items-center">
            <div
              ref={scrollRef}
              className="flex lg:flex-row flex-col mx-auto md:mx-0 lg:space-x-[20px] overflow-hidden scrollbar-hide snap-x lg:pl-4 gap-2"
            >
              {articles.map((article, index) => (
                ...
                >
                  <div className="snap-center flex-shrink-0 w-[350px] md:w-[450px] relative">
                    <img
                      src={article.img}
                      alt={article.title}
                      className="md:w-[450px] w-[350px] h-[305px] md:h-[380px] object-cover rounded-xl"
                    />
